...
def menu_size(event):
    ...
    name_font.configure(size=75+int(min(main.winfo_width()-dpi_window_size[0],main.winfo_height()-dpi_window_size[1])/5))
    start_button_font.config(size=40+int(min(main.winfo_width()-dpi_window_size[0],main.winfo_height()-dpi_window_size[1])/10))
...
settings.pack(padx=10*dpi,side="left")
