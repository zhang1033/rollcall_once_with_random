##NOTICE: 此项目我先暂停更新，因为我要有其它事情要做，先搁一会儿再说。
...
def edit_config(exist=None):
    ...
    try:
        def create():
            ...
            name_list_page_frame.config(bg="#a0a0ff")
            name_list_page_pre=tk.Button(name_list_page_frame,text="<",font=(30),relief="flat",bg="#8383d3",fg="#fefeff",activebackground="#8080d0",activeforeground="#dedee3")
            name_list_page_pre.place(height=30,width=20)
            name_list_page_nex=tk.Button(name_list_page_frame,text=">",font=(30),relief="flat",bg="#8383d3",fg="#fefeff",activebackground="#8080d0",activeforeground="#dedee3")
            name_list_page_nex.place(x=130,y=0,height=30,width=20)
            name_list_pages_entry=tk.Entry(name_list_page_frame,bg="#8383d3",relief="flat",fg="#fefeff",font=("楷体",18),insertbackground="#fefeff")
            name_list_pages_entry.place(x=20,y=0,height=30,width=40)
            name_list_page_split=tk.Label(name_list_page_frame,bg="#8383d3",relief="flat",fg="#fefeff",font=("楷体",18),text="/")
            name_list_page_split.place(x=60,y=0,height=30,width=15)
            name_list_page_max=tk.Entry(name_list_page_frame,bg="#8383d3",relief="flat",fg="#fefeff",font=("楷体",18),insertbackground="#fefeff",readonlybackground="#8383d3")
            name_list_page_max.insert(0,str(len(name_database)//200))
            name_list_page_max.config(state="readonly")
            name_list_page_max.place(x=75,y=0,height=30,width=55)
            edit_list_frame=tk.Frame(edit_frame,bg="#0a0aff",relief="flat")
            ...
            stopped=tk.IntVar()
            def add_namelist():
                for name_index in range(0,len(name_db_temp)//100+1,1):
                    if (name_index+1)*100>=len(name_db_temp):
                        rec=name_db_temp[100*name_index:len(name_db_temp):1]
                    else:
